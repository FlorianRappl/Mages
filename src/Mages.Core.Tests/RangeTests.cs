namespace Mages.Core.Tests
{
    ...
    public class RangeTests
    {
        ...
        {
            var range = RangeHelpers.Create(1, 10, 1);
        ...
        {
            var range = RangeHelpers.Create(1.5, 10.5, 2.3);
        ...
        {
            var range = RangeHelpers.Create(1, 10);
            Assert.AreEqual(10, range.GetCount());
            Assert.AreEqual(1.0, range[0, 0]);
            Assert.AreEqual(10.0, range[0, 9]);
        }
        ...
        {
            var range = RangeHelpers.Create(1.5, 10.1);
