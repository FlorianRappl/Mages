...
public enum ErrorCode
{
    ...
    /// See description.
    /// </summary>
    [Description("An expected JSX expression ( '<' ) or expression switch ( '{' }) was not found.")]
    JsxExpressionExpected,
    /// <summary>
    /// See description.
    /// </summary>
    ...
    /// See description.
    /// </summary>
    [Description("A JSX expression switch was not properly terminated ( '}' ).")]
    JsxExpressionNotTerminated,
    /// <summary>
    /// See description.
    /// </summary>
