...
{
    private static readonly NumberTokenizer Number = new();
    private static readonly StringTokenizer String = new();
    private static readonly CommentTokenizer Comment = new();
    private static readonly GeneralTokenizer Tokenizer = new(Number, String, Comment);
