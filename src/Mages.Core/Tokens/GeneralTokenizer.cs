    ...
    private IToken ScanSymbol(IScanner scanner)
    {
        ...
        switch (scanner.Current)
        {
            ...
            case CharacterTable.LessThan:
                ...
                else if (scanner.PeekMoveNext(CharacterTable.Slash))
                {
                    return new OperatorToken(TokenType.JsxStartClose, "</", start, scanner.Position);
                }
            ...
            case CharacterTable.Slash:
                if (scanner.PeekMoveNext(CharacterTable.GreaterThan))
                {
                    return new OperatorToken(TokenType.JsxEndClose, "/>", start, scanner.Position);
                }
