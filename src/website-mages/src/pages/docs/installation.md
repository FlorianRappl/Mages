...
The package targets .NET Standard 2.1. It provides the `Mages.Core` engine for parsing, validating, compiling, and evaluating MAGES source code. See [First Steps](/docs/first-steps) for examples of creating an `Engine` and evaluating expressions.
